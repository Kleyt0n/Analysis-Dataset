setwd("C:/Users/Dinho/Documents/course-project")

# Unzip dataSet to /data directory
unzip(zipfile="C:/Users/Dinho/Documents/course-project/Dataset.zip",exdir="./data")

# lets check the zip file and the new folder that has been unzipped
list.files("C:/Users/Dinho/Documents/course-project")

#define the path where the new folder has been unziped
pathdata = file.path("C:/Users/Dinho/Documents/course-project/data", "UCI HAR Dataset")
